    ...
    <div className="max-w-7xl mx-auto grid md:grid-cols-3 gap-12 text-left">
      <div>
        <div className="flex items-center gap-2 mb-4">
          ...
          <span className="font-bold">PM Club NSUT</span>
        </div>
      ...
      <div>
        ...
        <ul className="text-gray-500 text-sm space-y-3">
          ...
          <li><a href="/what-we-do" className="hover:text-cyan-400">What We Do</a></li>
        </ul>
      </div>
      <div>
        ...
        <ul className="text-gray-500 text-sm space-y-4">
          <li className="flex items-center gap-3"><Mail size={16} className="text-cyan-400"/> pmclub@nsut.ac.in</li>
          <li className="flex items-center gap-3"><Instagram size={16} className="text-cyan-400"/> @pmclub_nsut</li>
          <li className="flex items-center gap-3"><Linkedin size={16} className="text-cyan-400"/> PM Club NSUT</li>
        </ul>
      </div>
    </div>
